...
const SignUpPage = () => {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a]/90 flex items-center justify-center p-3 sm:p-4">
      <div className="w-full max-w-md">
        <div className="bg-[#0a0a0a]/90 rounded-xl sm:rounded-2xl shadow-xl overflow-hidden"
        style={{
          backgroundColor: COLORS.MEDIUM_GRAY,
        }}>
        
          {/* Header Section */}
          <div className="bg-gradient-to-r from-green-600 to-gray-700 px-4 sm:px-8 py-6 sm:py-12">
            <motion.div
            ...
            <div className="p-4 sm:p-6 md:p-8">
              <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
                <div className="space-y-1 sm:space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="block w-full pl-10 px-3 py-2 sm:py-3 rounded-lg sm:rounded-xl 
                ...
                <div className="space-y-1 sm:space-y-2">
                  ...
                  <div className="flex items-start mt-2 sm:mt-3">
                    <input
                      ...
                      className="mt-1 h-3 w-3 sm:h-4 sm:w-4 text-green-500 bg-gray-700 border-gray-600 rounded focus:ring-green-500"
                    />
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full py-2 sm:py-3 px-4 flex justify-center items-center bg-gradient-to-r 
