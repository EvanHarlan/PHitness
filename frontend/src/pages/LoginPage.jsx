    ...
    <div className="min-h-screen bg-[#0a0a0a]/90 flex items-center justify-center p-3 sm:p-4">
      <div className="w-full max-w-md">
        ...
        style={{
          ...
          {/* Header Section */}
          <div className="bg-gradient-to-r from-green-600 to-gray-700 px-4 sm:px-8 py-8 sm:py-12">
            <motion.div
                ...
                <div className="space-y-1 sm:space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="block w-full pl-10 px-3 py-2 sm:py-3 border border-gray-600 rounded-lg sm:rounded-xl 
                      bg-[#0a0a0a]/90 text-gray-100 placeholder-gray-400 
